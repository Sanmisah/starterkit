                    ...
                    this.datatable = new simpleDatatables.DataTable('#myTable', {
                        data: {
                            ...
                            data: [
                                ...
                                [ '{{ $user->name }}', '{{ $user->email }}', '<a href=""  class="btn btn-sm btn-outline-danger"> Delete</a> &nbsp; <a href="{{ route("profile.edit", ["user"=>$user->id]) }}"  class="btn btn-sm btn-outline-primary"> Edit</a>' 
                                ],
                                @endforeach
                                @endif
