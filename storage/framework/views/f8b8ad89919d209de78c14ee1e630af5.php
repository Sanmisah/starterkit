                                ...
                                <div x-show="addContactModal" x-transition x-transition.duration.300
                                    ...
                                    <div class="p-5">
                                        ...
                                        <?php echo csrf_field(); ?>   
                                            ...
                                            <div class="mb-5">
                                                <label for="occupation">D.O.B</label>
                                                <input id="occupation" type="text" name="dob" placeholder="Enter D.O.B"
                                                    class="form-input" x-model="params.dob" />
                                            </div>
                                            <div class="mb-5">
                        ...
                        <tbody>
                            <template x-for="contact in filterdContactsList" :key="contact.id">
                                <tr>
                                    ...
                                    <td x-text="contact.dob" class="whitespace-nowrap"></td>
                                    <td>
                                        <div class="flex gap-4 items-center justify-center">
                                            <button type="button" class="btn btn-sm btn-outline-primary"
                                                @click="editUser(contact)">Edit</button>
                                            
                                            <form x-bind:action="`student/${contact.id}`" method="Post" onsubmit="return confirm('Do you really want to Delete this Record')">
                                                <?php echo csrf_field(); ?>
